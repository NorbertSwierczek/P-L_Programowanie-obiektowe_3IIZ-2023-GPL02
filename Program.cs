...
class Program
{
    static void Main()
    {
        ...
        while (menu)
        {
            ...
            //DokumentFinansowy faktura = new DokumentFinansowy(1, "Faktura 2025/01", zalogowany.Nazwa, 1200);
            //DokumentKadrowy kadry = new DokumentKadrowy(2, "DokzKadr 2025/01", zalogowany.Nazwa, 0);
            //DokumentTechniczny tech = new DokumentTechniczny(3, "Techniczny Dokument 2024", zalogowany.Nazwa, "Dokument przedstawia wydatki działu technicznego");

            //repo.DodajDokument(faktura,zalogowany);
            //repo.DodajDokument(kadry,zalogowany);
            //repo.DodajDokument(tech,zalogowany);
            //repo.EdytujDokument(1, null, null, true, zalogowany);
